...
func getPopulationDeltas(_ people: [Person], _ minimum: Int, _ maximum: Int) -> [Int] {
    ...
    for person in people {
        let b = person.birthYear
        delta[b] += 1
        let d = person.deathYear
        delta[d + 1] -= 1
    }
    return delta
}
...
let p1 = Person(0, death: 50)
let p2 = Person(25, death: 75)
let p3 = Person(25, death: 80)
let p4 = Person(51, death: 99)

print(maxAliveYear([p1, p2, p3, p4], 0, 100))
